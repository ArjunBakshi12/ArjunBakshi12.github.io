...
$__System.registerDynamic("5", [], false, function ($__require, $__exports, $__module) {
  ...
  (function ($__global) {
    var objectFitImages = $__global["objectFitImages"];
    ...
    var objectFitImages = function () {
      ...
      function t(t) {
        ...
        for (var e, i = getComputedStyle(t).fontFamily, r = {}; null !== (e = l.exec(i));) r[e[1]] = e[2];return r;
      }function i(t, e, i) {
        g.width = e || 1, g.height = i || 1, t[a].width === g.width && t[a].height === g.height || (t[a].width = g.width, t[a].height = g.height, b.call(t, "src", g.toDataURL()));
      }function r(t, e) {
        t.naturalWidth ? e(t) : setTimeout(r, 100, t, e);
      }function n(n) {
        var s = e(n),
            o = n[a];if (s["object-fit"] = s["object-fit"] || "fill", !o.img) {
          if ("fill" === s["object-fit"]) return;if (!o.skipTest && f && !s["object-position"]) return;
        }if (!o.img) {
          o.img = new Image(n.width, n.height), o.img.srcset = p.call(n, "data-ofi-srcset") || n.srcset, o.img.src = p.call(n, "data-ofi-src") || n.src, b.call(n, "data-ofi-src", n.src), b.call(n, "data-ofi-srcset", n.srcset), i(n, n.naturalWidth || n.width, n.naturalHeight || n.height), n.srcset && (n.srcset = "");try {
            c(n);
          } catch (t) {
            window.console && console.log("http://bit.ly/ofi-old-browser");
          }
        }t(o.img), n.style.backgroundImage = "url(" + (o.img.currentSrc || o.img.src).replace("(", "%28").replace(")", "%29") + ")", n.style.backgroundPosition = s["object-position"] || "center", n.style.backgroundRepeat = "no-repeat", /scale-down/.test(s["object-fit"]) ? r(o.img, function () {
          o.img.naturalWidth > n.width || o.img.naturalHeight > n.height ? n.style.backgroundSize = "contain" : n.style.backgroundSize = "auto";
        }) : n.style.backgroundSize = s["object-fit"].replace("none", "auto").replace("fill", "100% 100%"), r(o.img, function (t) {
          i(n, t.naturalWidth, t.naturalHeight);
        });
      }function c(t) {
        var e = { get: function (e) {
            return t[a].img[e ? e : "src"];
          }, set: function (e, i) {
            return t[a].img[i ? i : "src"] = e, b.call(t, "data-ofi-" + i, e), n(t), e;
          } };Object.defineProperty(t, "src", e), Object.defineProperty(t, "currentSrc", { get: function () {
            return e.get("currentSrc");
          } }), Object.defineProperty(t, "srcset", { get: function () {
            return e.get("srcset");
          }, set: function (t) {
        ...
        var i = !w && !t;if (e = e || {}, t = t || "img", d && !e.skipTest || !h) return !1;"string" == typeof t ? t = document.querySelectorAll(t) : "length" in t || (t = [t]);for (var r = 0; r < t.length; r++) t[r][a] = t[r][a] || { skipTest: e.skipTest }, n(t[r]);i && (document.body.addEventListener("load", function (t) {
          "IMG" === t.target.tagName && o(t.target, { skipTest: e.skipTest });
        }, !0), w = !0, t = "img"), e.watchMQ && window.addEventListener("resize", o.bind(null, t, { skipTest: e.skipTest }));
      }var a = "bfred-it:object-fit-images",
          l = /(object-fit|object-position)\s*:\s*([-\w\s%]+)/g,
          u = new Image(),
          g = document.createElement("canvas"),
          f = "object-fit" in u.style,
          d = "object-position" in u.style,
          h = "background-size" in u.style && window.HTMLCanvasElement,
          m = "string" == typeof u.currentSrc,
          p = u.getAttribute,
          b = u.setAttribute,
          w = !1;return o.supportsObjectFit = f, o.supportsObjectPosition = d, s(), o;
    }();
    $__global["objectFitImages"] = objectFitImages;
  })(this);

  return _retrieveGlobal();
});
$__System.register("1", ["2", "3", "4", "5"], function (exports_1, context_1) {
    "use strict";
